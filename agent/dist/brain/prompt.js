...
exports.buildTradePrompt = buildTradePrompt;
const aggregator_js_1 = require("../guards/aggregator.js");
function buildTradePrompt(ctx) {
    ...
    const cautionList = (0, aggregator_js_1.activeCautionFlags)(guardResult.cautionFlags);
...
- Guard Verdict: ${(0, aggregator_js_1.verdictLabel)(guardResult.verdict)}
...
function formatToken(t, direction) {
